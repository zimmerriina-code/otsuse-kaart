  ...
  return (
    <main className="mx-auto max-w-5xl px-5 py-10 sm:px-8 sm:py-16">
          ...
          <div className="mt-5 grid gap-4 sm:grid-cols-2">
            {interp.nextSteps.map((s, i) => (
              <div key={i} className="rounded-2xl border border-border bg-card p-5">
                <h3 className="font-serif text-lg font-semibold text-navy">{s.title}</h3>
      ...
      {interp && interp.reflectionQuestions.length > 0 && (
        <section className="mt-8 rounded-2xl border border-border/60 bg-lavender/25 p-7 sm:p-9">
